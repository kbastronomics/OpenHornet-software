...
namespace DcsBios {
	...
	class PotentiometerMAT : PollingInput, public ResettableInput {
		private:
			void resetState()
			{
		...
		public:
			PotentiometerMAT(const char* msg, volatile unsigned char* argAddress, bool reverse = false, unsigned int input_min = 0, unsigned int input_max = 1023) :
	...
	typedef PotentiometerMAT<> MatPotentiometer;
}
